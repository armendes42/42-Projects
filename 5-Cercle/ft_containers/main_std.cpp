...
/*   Updated: 2022/11/27 17:57:19 by armendes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_constructor_vector(void)
{
    ...
    print_vector(third);
	vector<int> third1(0, 1, alloc);
	print_vector(third1);
	// vector<int> third2(third.max_size(), 1, alloc);
	// print_vector(third2);
    cout << endl;
...
void test_insert_vector(void)
{
    ...
    vector<int>::iterator it = first.insert(i, 2);
    print_vector(first);
	cout << *it << endl;
    cout << endl << endl;
...
void test_erase_vector(void)
{
    ...
    cout << endl;
    vector<int>::iterator i = first.begin() + 2;
    vector<int>::iterator it = first.erase(i);
    print_vector(first);
	cout << *it << endl;
	vector<int>::iterator it2 = first.erase(first.begin() + 3);
	print_vector(first);
	cout << *it2 << endl;
    cout << endl << endl;
    ...
    cout << endl;
    vector<int>::iterator j = second.begin() + 2;
    vector<int>::iterator jt = second.erase(j, j + 2);
    print_vector(second);
	cout << *jt << endl << endl;
	vector<int>::iterator jt2 = second.erase(second.begin() + 3, second.begin() + 5);
	print_vector(second);
	cout << *jt2 << endl << endl;
	vector<int>::iterator jt3 = second.erase(second.begin(), second.begin());
	print_vector(second);
	cout << *jt3 << endl;
    cout << endl;
}
...
void test_constructor_map(void)
{
    ...
    print_map(third);
	first['a'] = 5;
	map<char, int> third2(first.begin(), first.end());
	print_map(third2);
    cout << endl;
...
void test_insert_map(void)
{
	...
	pair<map<char, int>::iterator, bool> pr = first.insert(p1);
	print_map(first);
