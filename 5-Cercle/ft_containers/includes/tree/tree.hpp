...
/*   Updated: 2022/11/17 01:59:25 by armendes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    class tree
    {
        ...
        private:
            ...
            template <typename Key>
            node_pointer& find_pos(iterator hint, end_node_pointer& parent, const Key& key, node_pointer& dummy) const
            {
                if (hint == end() || value_comp()(key, *hint))
                {
                    // value < *hint
                    const iterator prev = hint;
