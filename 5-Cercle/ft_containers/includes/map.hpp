...
/*   Updated: 2022/11/17 01:59:32 by armendes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    class map
    {
        ...
        public:
            ...
            map(InputIt first, InputIt last, const key_compare& comp, const allocator_type& alloc = allocator_type()) : _tree(vt_compare(comp), alloc)
            {
                insert(first, last);
            }
            ...
            {
                _tree.erase(const_iterator(position));
            }
